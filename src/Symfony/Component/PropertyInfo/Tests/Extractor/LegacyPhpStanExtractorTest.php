 ...
 * @group legacy
 */
class LegacyPhpStanExtractorTest extends TestCase
{
    ...
    {
        $this->assertNull($this->extractor->getTypes(LegacyPhpStanOmittedParamTagTypeDocBlock::class, 'omittedType'));
    }
    ...
    {
        return [
            ['a', [new Type(Type::BUILTIN_TYPE_INT), new Type(Type::BUILTIN_TYPE_STRING)]],
            ...
            ['e', [
                new Type(Type::BUILTIN_TYPE_OBJECT, true, Dummy::class, true, [
                    new Type(Type::BUILTIN_TYPE_ARRAY, false, null, true, [], [new Type(Type::BUILTIN_TYPE_STRING)]),
                ], [
                    new Type(Type::BUILTIN_TYPE_INT),
                    new Type(Type::BUILTIN_TYPE_ARRAY, false, null, true, [
                        new Type(Type::BUILTIN_TYPE_INT),
                    ], [
                        new Type(Type::BUILTIN_TYPE_STRING, false, null, true, [], [new Type(Type::BUILTIN_TYPE_OBJECT, false, DefaultValue::class)]),
                    ]),
                ]),
                new Type(Type::BUILTIN_TYPE_OBJECT, true, ParentDummy::class),
            ]],
            ['f', null],
    ...
    public static function pseudoTypesProvider(): array
    {
        return [
            ...
            ['scalar', [new Type(Type::BUILTIN_TYPE_BOOL), new Type(Type::BUILTIN_TYPE_FLOAT), new Type(Type::BUILTIN_TYPE_INT), new Type(Type::BUILTIN_TYPE_STRING)]],
            ['number', [new Type(Type::BUILTIN_TYPE_FLOAT), new Type(Type::BUILTIN_TYPE_INT)]],
            ['numeric', [new Type(Type::BUILTIN_TYPE_FLOAT), new Type(Type::BUILTIN_TYPE_INT), new Type(Type::BUILTIN_TYPE_STRING)]],
            ['arrayKey', [new Type(Type::BUILTIN_TYPE_INT), new Type(Type::BUILTIN_TYPE_STRING)]],
...
class LegacyPhpStanOmittedParamTagTypeDocBlock
{
    /**
